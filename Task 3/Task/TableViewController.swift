...
class TableViewController: UITableViewController {
    ...
    var profissionaisProgramacao = [Profissionais]()
     var profissionaisFinanca = [Profissionais]()
     var profissionaisMarketing = [Profissionais]()
    

    override func viewDidLoad() {
        super.viewDidLoad()
        
        profissionaisProgramacao = Profissionais.ProfissionaisProgramacaoDAO.getList();
        profissionaisFinanca = Profissionais.ProfissionaisProgramacaoDAO.getList();

        profissionaisMarketing = Profissionais.ProfissionaisProgramacaoDAO.getList();
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return profissionaisProgramacao.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let profissionaisCell = cell as? ProfissionaisTableViewCell{
            ...
            let profissional = profissionaisProgramacao[indexPath.row]
    ...
    */
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "exibirInfoProfissionais"{
            ...
            if let profissionalView = segue.destination as? InfoProfissionaisViewController {
               ...
               let celulaSelecionada = tableView.indexPathForSelectedRow?.row
                let profissionalCelula = profissionaisProgramacao[celulaSelecionada!]
